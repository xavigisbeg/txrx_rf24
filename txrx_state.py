...
def main():
    ...
    while True:
        ...
        # Transmitter states
            ...
            state = run_st_tx_transmission_send_msg(tx_list_of_frames, tx_frame_num)
        ...
        # Receiver states
            ...
            state, rx_message_to_add_to_file = run_st_rx_transmission_init()

        elif state == STATE_RX_TRANSMISSION_RECEIVE_MSG:
            state, rx_message_to_add_to_file = run_st_rx_transmission_receive_msg(rx_message_to_add_to_file)
